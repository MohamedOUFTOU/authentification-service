...
public class AuthentificationServiceApplication {
    ...
    CommandLineRunner start(AccountService accountService){
        return  args -> {
            ...
            accountService.addNewRole(new AppRole(null,"COSTUMERS_MANAGER"));
            ...
            accountService.addRoleToUser("user1","PRODUCTS_MANAGER");
            accountService.addRoleToUser("user2","BILLS_MANAGER");
            accountService.addRoleToUser("user3","COSTUMERS_MANAGER");
        };
